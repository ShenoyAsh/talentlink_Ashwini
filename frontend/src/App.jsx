    ...
    <>
        ...
        <Container className="py-5">
            ...
            <Row>
                ...
                <Col md={4} className="mb-3"><Card className="h-100"><Card.Body><Card.Title>Content Writer for Tech Blog</Card.Title><Card.Text>Seeking a writer for long-form articles about AI and machine learning.</Card.Text><Badge bg="secondary">Content Writing</Badge></Card.Body><Card.Footer className="fw-bold">$50 / hour</Card.Footer></Card></Col>
            </Row>
        </Container>
    </>
    )
